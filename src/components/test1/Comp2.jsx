...
export default class Comp2 extends Component {
    ...
    renderEdit = () => {
        return (
            <a href="#" className="btn btn-primary" onClick={ () => this.onClickEdit()}>Edit 1</a>
        )
    }

    renderAdd = () => (
        <div className="input-group mb-3">
            <button onClick={ () => this.onClickAdd()} className="btn btn-outline-secondary" type="button" id="button-addon1">Add</button>
